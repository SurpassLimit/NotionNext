...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SurpassLimit', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的OIer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://belimit.us.kg', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个学生,Hi，我是一个普通人,欢迎来到我的博客🎉',
